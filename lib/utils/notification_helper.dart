...
import 'package:norification_app/utils/received_notification.dart';
...
class NotificationHelper {
  ...
  /// ======= START NOTIFICATION FUNCTION CODE==========
  ...
  // show notification without body
  ...
  // 1. create a download function to get email from internet
  ...
  // 2. show notification with big image [for android]
  ...
  // 3. show notification with image [for IOS]
  ...
  // handling for open pages from notification
